...
export const heroSlides = [
  {
    ...
    description:
      'EFCARE là nền tảng chăm sóc sức khỏe đa thế hệ kết nối công nghệ, bác sĩ, cộng đồng và gia đình trong một hệ sinh thái minh bạch, chuyên nghiệp và bền vững.',
  ...
  },
  {
    ...
    description:
      'Thiết bị EFCARE kết hợp AI thông minh theo dõi liên tục các chỉ số sức khỏe, phát hiện bất thường và cảnh báo kịp thời — bảo vệ gia đình bạn mọi lúc, mọi nơi.',
  ...
  },
  {
    ...
    description:
      'EFCARE đồng hành cùng người mắc bệnh mạn tính với giải pháp theo dõi chuyên sâu, ngăn ngừa sớm biến chứng và phục hồi bền vững — đội ngũ cộng tác viên luôn bên cạnh.',
